...
// Build everything.
gulp.task('build', gulp.series(gulp.parallel(gulp.series('styles:production', 'scripts:production', 'app:production'), 'images', 'fonts', 'favicon'), 'collectstatic'));

// Watch everything.
gulp.task('watch', gulp.series('build', gulp.parallel('watch:css', 'watch:js', 'watch:images', 'watch:fonts', 'watch:static')));
